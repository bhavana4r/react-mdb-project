...
const useAutocompleteKeydown = ({ isOpen, setIsOpen, length }: useAutocompleteKeydownProps) => {
  ...
  const handleKeydown = useCallback(
    (e: KeyboardEvent) => {
      ...
      if (isEscape || isEnter || isTab) return setIsOpen(false);
