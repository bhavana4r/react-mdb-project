...
const MDBTimePickerClock: React.FC<TimePickerClockProps> = React.forwardRef<HTMLDivElement, TimePickerClockProps>(
  ({ ...props }, ref) => {
    ...
    const onMouseUp = (e: any) => {
      ...
      if (mode === 'hours') {
        switchHoursToMinutesOnClick && setMode('minutes');
    ...
    const handleDrag = useCallback(
      (e: any) => {
        ...
        if (mode === 'hours') {
          ...
          if (handAngle === 0) {
            if (
              !areMinutesDisabled(minHour, maxHour, activeHour, 0, maxMinute, minMinute, period, maxPeriod, minPeriod)
            ) {
              setActiveMinute(0);
              setMinuteAngle(360);
            }
            ...
            if (
              ...
              setActiveMinute(newValue / 6 === 60 ? 0 : newValue / 6);
